...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        ...
        trajs, envsteps_this_batch = utils.sample_trajectories(env, agent.actor, args.batch_size, max_ep_len) # Done
        ...
        dones = trajs_dict["terminal"]
        train_info: dict = agent.update(obs, actions, rewards, dones)
